...
int local_rssi_value=-96;

void local_rssi_callback(std_msgs::Int8 rssi_msg)
{
	local_rssi_value=rssi_msg.data;
...
{
	ros::init(argc,argv,"local_initial_scan");
	ros::NodeHandle n;
	pwm_pub = n.advertise<std_msgs::Int16>("local_pwm",1);
	local_rssi=n.subscribe("local_rssi",1,local_rssi_callback);
