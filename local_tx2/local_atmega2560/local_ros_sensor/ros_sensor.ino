...
ros::Publisher local_rssi("local_rssi", &rssi_val);


sensor_msgs::NavSatFix gps_val;
ros::Publisher local_gps("local_gps", &gps_val);
...
ros::Subscriber<std_msgs::Int16> pwm_sub("/local_pwm", motor_pwm_Cb);
...
// rssi
  ...
  delay(500);
  nh.advertise(local_rssi);
  delay(500);
  nh.advertise(local_gps);
  GPS.begin(9600);
