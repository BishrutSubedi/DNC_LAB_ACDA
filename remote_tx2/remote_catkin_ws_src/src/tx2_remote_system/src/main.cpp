...
int main(int argc, char **argv)
{
	...
	ros::init(argc,argv,"remote_system");
	ros::NodeHandle n;

    //declare the publishers and subscriber
	com_pub=n.advertise<std_msgs::Float64>("remote_com",1);
	baro_pub=n.advertise<std_msgs::Float64MultiArray>("remote_baro",1);
    ...
    ros_serial = n.advertise<std_msgs::String>("remote_ros_serial",1);
